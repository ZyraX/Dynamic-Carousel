		...
		carousel = {
			init : function() {
				...
				$slidewrap.each(function(carInt) {
					...
					.unbind('carouselmove').bind( 'carouselmove' , carousel.move )
					.unbind('nextprev').bind( 'nextprev'     , carousel.nextPrev )
					.unbind('navstate').bind( 'navstate'     , carousel.navState );

					$slide
					.css({
						"float": "left",
						width: $slider.width()/slidenum
					})
					.each(function(i) {
						var $el = $(this);
...
navState : function(e, ui) {
	...
	$el.attr('aria-activedescendant', $activeSlide[0].id);
		...
		$slidewrap.unbind("dragSnap").bind( "dragSnap", setup, function(e, ui){
		...
		$slidewrap.filter('[data-autorotate]').each(function() {
			...
			.unbind('mouseenter click touchstart').bind('mouseenter click touchstart', function() {
				clearInterval(auto);
			});
		});
	...
	$.event.special.dragSnap = {
		setup: function(setup) {
			...
			$el.unbind("snapback").unbind("touchstart")
			...
			.bind("touchstart", function(e) {
				...
				function moveHandler(e) {
					...
					$el
					.unbind("gesturestart").bind("gesturestart", function(e) {
						$el
						.unbind("touchmove", moveHandler)
						.unbind("touchend", moveHandler);
					})
					.unbind("touchmove").bind("touchmove", moveHandler)
